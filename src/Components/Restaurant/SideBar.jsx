...
import { BiSolidBarChartSquare, BiSolidUserRectangle,BiFoodMenu } from 'react-icons/bi'
...
function SideBar() {
  ...
  const Menus = [
    ...
    { title: "Add Product", icon: <AiOutlinePlusSquare/> , path: "/restaurant/addproduct"},
    { title: "Products", icon: <MdFastfood/>,  path: "/restaurant/products" },
